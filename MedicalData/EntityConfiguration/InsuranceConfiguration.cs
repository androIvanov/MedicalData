...
namespace MedicalData.EntityConfiguration
{
    class InsuranceConfiguration : IEntityTypeConfiguration<Insurance>
    {
        public void Configure(EntityTypeBuilder<Insurance> builder)
        {
			...
			builder.Property(p => p.PlanEffectiveDate).HasColumnType("datetime");
			...
			builder.Property(p => p.InsuredsDateOfBirth).HasColumnType("datetime").IsRequired(); ////////////
			...
			builder.Property(p => p.NoticeofAdmissionDate).HasColumnType("datetime");
			builder.Property(p => p.ReportofEligibilityCode).HasColumnType("varbinary(50)").IsRequired();
			builder.Property(p => p.ReportofEligibilityDate).HasColumnType("datetime").IsRequired();
			builder.Property(p => p.PreAdmitCertification).HasColumnType("nvarchar(255)").IsRequired();
			builder.Property(p => p.VerificationDateTime).HasColumnType("datetime").IsRequired();
			...
			builder.Property(p => p.CertificationDateTime).HasColumnType("datetime");
			builder.Property(p => p.CertificationModifyDateTime).HasColumnType("datetime");
