...
namespace MedicalData.Migrations
{
    ...
    [Migration("20201204131612_allDOne")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MedicalData.Entities.ClaimPayments", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ClaimPaymentAmount = 999m,
                            ClaimPaymentPeriodEndDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            ClaimPaymentPeriodStartDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            ClaimRecivedDate = new DateTime(2020, 12, 4, 13, 16, 11, 341, DateTimeKind.Utc).AddTicks(3567),
                            ClaimStatusCode = "PS",
                            CoverageAmount = 0m,
                            MessageId = 1,
            ...
            modelBuilder.Entity("MedicalData.Entities.Diagnosis", b =>
                {
                    ...
                    b.Property<int?>("PatientAccountAccountId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("PatientAccountAccountId");
            ...
            modelBuilder.Entity("MedicalData.Entities.EDI835Message", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            MessageId = 1,
                            DateAdded = new DateTime(2020, 12, 4, 13, 16, 11, 342, DateTimeKind.Utc).AddTicks(317),
            ...
            modelBuilder.Entity("MedicalData.Entities.EDI837Message", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            MessageId = 1,
                            DateAdded = new DateTime(2020, 12, 4, 13, 16, 11, 350, DateTimeKind.Utc).AddTicks(5265),
                            Message = "All good"
                        });
                });
            ...
            modelBuilder.Entity("MedicalData.Entities.Guarantors", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccountId = 1,
                            City = "Sofia",
                            DateOfBirth = new DateTime(2020, 12, 4, 13, 16, 11, 345, DateTimeKind.Utc).AddTicks(6732),
                            FamilyName = "Ivanov",
                            GivenName = "Stoqn",
                            MiddleName = "Jack",
                            SetID = "545NM349Y46",
            ...
            modelBuilder.Entity("MedicalData.Entities.Insurance", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CertificationBeginDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            CertificationDateTime = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            CertificationEndDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            CertificationModifyDateTime = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            ...
                            InsuredsDateOfBirth = new DateTime(2005, 9, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            InsuredsIDNumber = "0YR72TL49Z5",
                            NoticeofAdmissionCode = new byte[] { 0 },
                            NoticeofAdmissionDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            PlanCode = "SSG",
                            PlanEffectiveDate = new DateTime(2020, 12, 4, 13, 16, 11, 346, DateTimeKind.Utc).AddTicks(1769),
                            PlanExpirationDate = new DateTime(2005, 9, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            PlanType = "Good",
                            PolicyNumber = "2456",
                            PreAdmitCertification = "Certificacate",
                            RelationshiptoPatient = "Daenerys",
                            ReportofEligibilityCode = new byte[] { 13 },
                            ReportofEligibilityDate = new DateTime(2005, 9, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            SetID = "GIO6543",
                            SetIDIN2 = "8y2903rj",
                            SetIDIN3 = "GHOP04U78",
                            VerificationBy = "Jack Morrison",
                            VerificationDateTime = new DateTime(2005, 9, 1, 0, 0, 0, 0, DateTimeKind.Unspecified)
                        });
                });
            ...
            modelBuilder.Entity("MedicalData.Entities.LineNumber", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            LineNumberId = 10,
                            FacilityTypeCode = "GA",
                            FiscalPeriodDate = new DateTime(2020, 12, 4, 13, 16, 11, 340, DateTimeKind.Utc).AddTicks(6276),
                            ProviderId = "PROVIDER225",
                            TotalClaimChargeAmount = 2421m,
            ...
            modelBuilder.Entity("MedicalData.Entities.Patient", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            PatientId = 1,
                            DateOfBirth = new DateTime(2020, 12, 4, 13, 16, 11, 349, DateTimeKind.Utc).AddTicks(8859),
            ...
            modelBuilder.Entity("MedicalData.Entities.Person", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            BirthOrder = 0,
                            City = "Varna",
                            DateOfBirth = new DateTime(2020, 12, 4, 13, 16, 11, 344, DateTimeKind.Utc).AddTicks(2650),
            ...
            modelBuilder.Entity("MedicalData.Entities.Procedure", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ProcedureDateTime = new DateTime(2020, 12, 4, 13, 16, 11, 345, DateTimeKind.Utc).AddTicks(1342),
            ...
            modelBuilder.Entity("MedicalData.Entities.PtdScore", b =>
                {
                    ...
                    b.Property<string>("CallsToActionsCode")
                        .HasColumnType("nvarchar(50)");
            ...
            modelBuilder.Entity("MedicalData.Entities.ServiceLine", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Quantity = 3.5m,
                            ServiceDateTime = new DateTime(2020, 12, 4, 13, 16, 11, 350, DateTimeKind.Utc).AddTicks(9359),
                            ServiceID = "ghi7654",
            ...
            modelBuilder.Entity("MedicalData.Entities.Transaction", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            TransactionId = 1,
                            CheckIssueOrEFTEffectiveDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            CreditDebitFlag = "C",
                            EFTTraceNumber = "G457JFHG437535HU358",
                            PayeeName = "Robert",
                            PaymentMethodCode = "FST",
                            ProductionDate_REF_405 = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            TotalActualProviderPaymentAmount = 2999m,
            ...
            modelBuilder.Entity("MedicalData.Entities.Visit", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ActualLengthOfIPStay = 0,
                            AdmitDateTime = new DateTime(2020, 12, 4, 13, 16, 11, 343, DateTimeKind.Utc).AddTicks(7120),
                            ...
                            ContractAmount = 0m,
                            ContractEffectiveDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            ContractPeriod = 0,
                            CurrentPatientBalance = 0m,
                            DeleteAccountDate = new DateTime(2020, 12, 4, 13, 16, 11, 343, DateTimeKind.Utc).AddTicks(6270),
                            DeleteAccountIndicator = "NO",
                            DischargeDateTime = new DateTime(2020, 12, 4, 13, 16, 11, 343, DateTimeKind.Utc).AddTicks(7552),
                            EstimatedLengthOfIPstay = 0,
                            ExpectedAdmitDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            ExpectedDischargeDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
            ...
            modelBuilder.Entity("MedicalData.Entities.Eligibility", b =>
                {
                    b.HasOne("MedicalData.Entities.Insurance", "Insurance")
            ...
            modelBuilder.Entity("MedicalData.Entities.Insurance", b =>
                {
                    b.HasOne("MedicalData.Entities.Guarantors", "Guarantor")
                        .WithMany("Insurances")
            ...
            modelBuilder.Entity("MedicalData.Entities.Procedure", b =>
                {
                    b.HasOne("MedicalData.Entities.Diagnosis", "Diagnosis")
                        .WithMany("Procedures")
            ...
            modelBuilder.Entity("MedicalData.Entities.PtdScore", b =>
                {
                    b.HasOne("MedicalData.Entities.CallsToActions", "CallsToActions")
                        .WithMany("PtdScores")
                        .HasForeignKey("CallsToActionsCode");

                    b.HasOne("MedicalData.Entities.PatientAccount", "PatientAccount")
                        .WithMany("PtdScores")
                        .HasForeignKey("PatientAccountAccountId");

                    b.Navigation("CallsToActions");
